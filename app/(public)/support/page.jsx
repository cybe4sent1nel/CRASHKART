    ...
    const loadConversationHistory = async (email) => {
        try {
            ...
            if (res.ok && data.messages) {
                ...
                setMessages([{
                    id: Date.now(),
                    text: "Hello! I'm Inquirae, your CrashKart support assistant. I'm here to help you with your orders, complaints, or any queries. Please select an order or type your message to get started!",
                    sender: 'bot',
                    timestamp: new Date()
                }])
            }
                ...
                <div className="flex-1 w-full px-6 py-4">
                    <div className="relative bg-white/95 backdrop-blur-md rounded-2xl shadow-2xl border border-pink-200 h-[calc(100vh-120px)] flex flex-col overflow-hidden">
                        ...
                        {uploadedFiles.length > 0 && (
                            <div className="relative z-10 border-t border-pink-200 p-4 bg-pink-50">
                                <div className="flex gap-2 overflow-x-auto">
                                    {uploadedFiles.map((file, idx) => (
                                        <div key={idx} className="relative bg-white border border-pink-200 rounded-lg p-2 flex-shrink-0">
                                            {file.type === 'image' ? (
                                                <IKImage
                                                    urlEndpoint={urlEndpoint}
                                                    path={file.url}
                                ...
                                <div className="flex items-end gap-2">
                                    <div className="flex gap-2">
                                        ...
                                        <button
                                            ...
                                            className="p-3 bg-gradient-to-r from-pink-500 to-purple-500 hover:from-pink-600 hover:to-purple-600 text-white rounded-xl transition shadow-sm"
                                            title="Upload Image"
                                        >
                                            <ImagePlus size={20} />
                                        </button>
