            ...
            <div className="max-w-3xl mx-auto">
                ...
                <div className="bg-white rounded-2xl shadow-xl p-8 border border-pink-200">
                    <div className="flex items-start justify-between mb-6">
                        <div>
                            <h1 className="text-3xl font-bold text-slate-800">Support Ticket</h1>
                            <p className="text-slate-600 mt-1">ID: {ticket.id.slice(-8).toUpperCase()}</p>
                        </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <div>
                            ...
                            <p className="text-lg text-slate-800">{ticket.subject}</p>
                        </div>
                        ...
                        <div>
                            ...
                            <p className="text-slate-700 capitalize">{ticket.category}</p>
                        </div>
                        ...
                        {ticket.resolvedAt && (
                            <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                                <h3 className="text-sm font-semibold text-green-800 mb-2">Resolved</h3>
                                <p className="text-green-700">{new Date(ticket.resolvedAt).toLocaleString()}</p>
                            </div>
                        )}

                        <div className="bg-gradient-to-r from-pink-100 to-purple-100 rounded-lg p-4">
                            <p className="text-sm text-slate-700">
                                💡 Our support team is working on your ticket. You'll receive email updates at each stage.
                                For urgent matters, contact <a href="mailto:support@crashkart.com" className="text-pink-600 font-semibold">support@crashkart.com</a>
                            </p>
                        </div>
                    </div>
                </div>
