                ...
                <div className="space-y-8">
                    ...
                    <section className="bg-white dark:bg-slate-800 rounded-lg p-8 border border-slate-200 dark:border-slate-700">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <a href="mailto:support@crashkart.com" className="p-4 border border-slate-200 dark:border-slate-700 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-700/50 transition">
                                <h4 className="font-semibold text-slate-800 dark:text-white mb-1">Email Support</h4>
                                <p className="text-sm text-slate-600 dark:text-slate-400">support@crashkart.com</p>
                            </a>
                        </div>
                    </section>
                </div>
