...
export default function VerifyOTP() {
    ...
    const handleVerify = (e) => {
        ...
        const newUser = {
            ...
            email: signupData.email || `user_${Date.now()}@crashkart.local`,
                    ...
                    <div className="text-center mb-8">
                        ...
                        <p className="text-slate-600 mb-2">
                            {otpType === 'email'
                                ...
                                : `We've sent a 6-digit OTP via WhatsApp to +91${signupData.phone}`}
                        </p>
                        <p className="text-sm text-slate-500">Enter the OTP below to verify your account</p>
                    </div>
