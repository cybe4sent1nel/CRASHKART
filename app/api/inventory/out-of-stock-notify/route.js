      ...
      try {
        await sendEmail({
          ...
          html: `
            ...
            <p><a href="${process.env.NEXTAUTH_URL || 'http://localhost:3000'}/seller/inventory" style="color: #dc2626; text-decoration: none;">Update Inventory</a></p>
      ...
      try {
        await sendEmail({
          ...
          html: `
            ...
            <p><a href="${process.env.NEXTAUTH_URL || 'http://localhost:3000'}/admin/inventory" style="color: #dc2626; text-decoration: none;">View in Admin Inventory</a></p>
          `
        })
      } catch (emailError) {
