...
export default function GooglePayStyleScratchCard({ onReveal, onClose }) {
    ...
    useEffect(() => {
        ...
        // Google Pay style gradient background with texture
    ...
    const addCrashCashToWallet = async (amount) => {
        try {
            ...
            const response = await fetch('/api/user/crashcash/add', {
                ...
                body: JSON.stringify({ amount, source: 'scratch-card' })
            })
