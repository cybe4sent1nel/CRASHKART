                            ...
                            <div className='p-4 flex flex-col h-full'>
                                ...
                                <div className='flex items-center gap-2 mb-2'>
                                    ...
                                    <div className='flex gap-2 mt-auto'>
                                        <button onClick={(e) => handleAddToCart(product, e)} className='flex-1 flex items-center justify-center gap-2 bg-slate-800 hover:bg-slate-900 text-white py-2 rounded-lg transition font-medium text-sm'>
                                            <ShoppingCart size={14} />
                                            Add
                                        </button>
                                        <button onClick={(e) => {
                                            handleBuyNow(product, e)
                                        }} className='flex-1 flex items-center justify-center gap-2 bg-red-600 hover:bg-red-700 text-white py-2 rounded-lg transition font-medium text-sm'>
                                            Buy
                                        </button>
                                    </div>
                                </div>
