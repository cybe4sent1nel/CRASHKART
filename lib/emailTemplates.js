...
// Helper function for logo header (supports inline attachment via CID)
const getLogoHeader = (useLogo = true) => {
    return `
        <div style="background-color: #f3f4f6; padding: 20px; text-align: center; border-radius: 8px; margin-bottom: 20px;">
            ${useLogo ? '<img src="cid:crashkart-logo" alt="CrashKart" style="max-width: 150px; height: auto; margin-bottom: 10px; display: block; margin-left: auto; margin-right: auto;">' : ''}
