...
// Helper function for logo header with external URL
const getLogoHeader = (useLogo = true) => {
    return `
        <div style="background-color: #f3f4f6; padding: 20px; text-align: center; border-radius: 8px; margin-bottom: 20px;">
            ${useLogo ? '<img src="https://jumpshare.com/s/77zqp34kls202uw70X0Q" alt="CrashKart" style="max-width: 150px; height: auto; margin-bottom: 10px; display: block; margin-left: auto; margin-right: auto;">' : ''}
            <h1 style="color: #ef4444; margin: ${useLogo ? '10px 0 0 0' : '0'}; font-size: 32px; font-weight: bold;">crashkart</h1>
            <p style="color: #6b7280; margin: 8px 0 0 0; font-size: 14px;">Your Shopping Destination</p>
        </div>
    `;
};
                    ...
                    <div class="header">
                     ...
                     <div class="content">
                        ...
                        <p style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #e5e7eb;">
                            If you have any questions, please <a href="mailto:support@crashkart.com" style="color: #ef4444; text-decoration: none;">contact our support team</a>.
                        </p>
...
export const welcomeEmail = (name) => {
    return {
        subject: '🎉 Welcome to CrashKart - Your Shopping Awaits!',
        html: `
            <!DOCTYPE html>
            <html>
            <head>
                    ...
                    <div class="header">
                     ...
                     <div class="content">
                        ...
                        <div class="bonus-box">
                            ...
                            Start your journey with exclusive deals available only for new members!
                        </div>
                        
                        <p style="text-align: center;">
                            <a href="${process.env.NEXT_PUBLIC_APP_URL || 'https://crashkart.com'}/shop" class="cta-button">🛍️ Start Shopping</a>
                        </p>
        ...
        html: `
            ...
            <body>
                <div style="max-width: 600px; margin: 0 auto; padding: 40px; background: white;">
                    ...
                    <p>Hi ${name},</p>
                    <p>Your refund of ₹${refundData.amount} has been processed.</p>
                    <p>Amount: ₹${refundData.amount}</p>
                    <p>Refund Method: ${refundData.method}</p>
                    <p>The amount will be credited within 3-5 business days.</p>
                </div>
            </body>
            </html>
        `
