...
export function generateInvoiceHTML(orderData) {
    ...
    // CrashKart Logo SVG (inline)
    const logoSVG = `<svg width="150" height="50" viewBox="0 0 200 60" xmlns="http://www.w3.org/2000/svg">
        <defs>
        ...
        <!-- Shopping Cart Icon -->
        <path d="M15 15 L20 15 L25 35 L55 35 L60 20 L25 20" stroke="url(#cartGradient)" stroke-width="3" fill="none" stroke-linecap="round" stroke-linejoin="round"/>
        <circle cx="30" cy="42" r="3" fill="url(#cartGradient)"/>
        <circle cx="50" cy="42" r="3" fill="url(#cartGradient)"/>
        <path d="M25 25 L27 30 M30 25 L32 30 M35 25 L37 30" stroke="#fbbf24" stroke-width="2" stroke-linecap="round"/>
        <!-- Text -->
        <text x="70" y="35" font-family="Arial, sans-serif" font-size="24" font-weight="bold" fill="#ef4444">CRASH</text>
        <text x="140" y="35" font-family="Arial, sans-serif" font-size="24" font-weight="bold" fill="#1f2937">CART</text>
        <text x="70" y="48" font-family="Arial, sans-serif" font-size="10" fill="#6b7280">Your Shopping Destination</text>
    </svg>`;
