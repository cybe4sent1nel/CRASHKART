...
export function generateInvoiceHTML(orderData) {
    ...
    const qrData = encodeURIComponent(JSON.stringify({
        ...
        total,
        date: orderDate,
        trackUrl: `${process.env.NEXT_PUBLIC_APP_URL || 'https://crashkart.vercel.app'}/my-orders`
    }));
    const qrCodeUrl = `https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=${qrData}&bgcolor=FFFFFF&color=000000&format=png`;

    // CrashKart Logo SVG (inline) with better visibility
    const logoSVG = `<svg width="180" height="60" viewBox="0 0 200 60" xmlns="http://www.w3.org/2000/svg" style="display: block;">
        <defs>
            <linearGradient id="cartGradient${orderId}" x1="0%" y1="0%" x2="100%" y2="100%">
                <stop offset="0%" style="stop-color:#ef4444;stop-opacity:1" />
                <stop offset="100%" style="stop-color:#dc2626;stop-opacity:1" />
            </linearGradient>
        </defs>
        <!-- Background -->
        <rect x="0" y="0" width="200" height="60" fill="#ffffff" opacity="0"/>
        <!-- Shopping Cart Icon -->
        <path d="M15 15 L20 15 L25 35 L55 35 L60 20 L25 20" stroke="url(#cartGradient${orderId})" stroke-width="3" fill="none" stroke-linecap="round" stroke-linejoin="round"/>
        <circle cx="30" cy="42" r="3" fill="url(#cartGradient${orderId})"/>
        <circle cx="50" cy="42" r="3" fill="url(#cartGradient${orderId})"/>
        <path d="M25 25 L27 30 M30 25 L32 30 M35 25 L37 30" stroke="#fbbf24" stroke-width="2" stroke-linecap="round"/>
        <!-- Text -->
        <text x="70" y="35" font-family="Arial, sans-serif" font-size="26" font-weight="bold" fill="#ef4444">CRASH</text>
        <text x="145" y="35" font-family="Arial, sans-serif" font-size="26" font-weight="bold" fill="#1f2937">CART</text>
        <text x="70" y="50" font-family="Arial, sans-serif" font-size="10" fill="#6b7280">Your Shopping Destination</text>
    </svg>`;
        ...
        <body>
            <div class="invoice-container">
                <div class="invoice-header">
                    <div class="company-info">
                        ...
                        <div class="company-details">
                            ...
                            <p>📧 support@crashkart.com</p>
                            <p>☎️ 1800-123-4567 (Toll Free)</p>
                ...
                <div class="footer">
                    ...
                    <p>For any queries, please contact our customer support at support@crashkart.com or call 1800-123-4567</p>
