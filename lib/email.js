...
// CrashKart Logo HTML for emails - Using actual logo from LOGO.html
const CRASHKART_LOGO_HTML = `
<div style="text-align: center; padding: 20px 0; margin-bottom: 20px;">
    <img src="data:image/png;base64," alt="CRASHKART Logo" style="max-width: 200px; height: auto; display: block; margin: 0 auto;">
</div>
`;
...
async function sendEmailInternal(to, subject, html, fromName = APP_NAME, attachments = null) {
  try {
    ...
    if (!html.includes('<!-- LOGO -->') && !html.includes(CRASHKART_LOGO_HTML)) {
