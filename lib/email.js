 ...
 */
function getLogoUrl() {
  return 'https://jumpshare.com/s/77zqp34kls202uw70X0Q';
}
...
async function sendEmailInternal(to, subject, html, fromName = APP_NAME, attachments = null) {
  try {
    ...
    // Handle attachment options (skip logo attachments - using URL instead)
    if (attachments === 'include-logo' || attachments === 'include-logo-and-products') {
      // Logo is now embedded via URL in templates, no attachments needed
    ...
    <body>
      <div class="email-wrapper">
         <div class="logo-header">
           <img src="https://jumpshare.com/s/77zqp34kls202uw70X0Q" alt="CrashKart" />
           <h1>crashkart</h1>
